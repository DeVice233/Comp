...
namespace Comp
{
    public static class PageManager
    {
        ...
        static PageManager()
        {
            RegisterPageType(PageType.ComputerList, typeof(ComputerList), typeof(ComputerListVM));
            RegisterPageType(PageType.EditComputer, typeof(EditComputer), typeof(EditComputerVM));
        }
